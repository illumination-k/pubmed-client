...
Do not create commit messages and push. You only provide the code changes needed to fix the CI issues. Manually verify that the changes you suggest will fix the issues.
