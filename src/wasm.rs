...
//!
//! **Note**: This module is only compiled when both the `wasm` feature is enabled and
//! the target architecture is `wasm32`. For linting purposes on non-WASM targets,
//! this module remains empty.
...
#[cfg(all(feature = "wasm", target_arch = "wasm32"))]
pub use wasm_impl::{WasmClientConfig, WasmPubMedClient};

// When WASM is not available, provide empty stubs for documentation/linting
