...
impl SearchQuery {
    ...
    ///
    /// ```
    /// use pubmed_client::query::SearchQuery;
    ///
    ...
    ///
    /// ```
    /// use pubmed_client::query::{SearchQuery, ArticleType};
    ///
    /// let query = SearchQuery::new()
    ///     .query("hypertension")
    ...
    ///
    /// ```
    /// use pubmed_client::query::{SearchQuery, Language};
    ///
    /// let query = SearchQuery::new()
    ///     .query("stem cells")
    ...
    ///
    /// ```no_run
    /// use pubmed_client::{PubMedClient, query::SearchQuery};
    ///
    /// #[tokio::main]
