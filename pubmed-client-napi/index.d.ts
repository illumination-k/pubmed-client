...
export declare class PubMedClient {
   ...
   * @returns Array of article metadata
   */
  fetchArticles(pmids: Array<string>): Promise<Array<Article>>
  /**
   ...
   */
  fetchSummaries(pmids: Array<string>): Promise<Array<Summary>>
  /**
   ...
   * @returns Array of article summaries
   */
  searchSummaries(query: string, limit?: number | undefined | null): Promise<Array<Summary>>
  /**
   ...
   */
  spellCheck(term: string): Promise<SpellCheckResult>
  /**
   ...
   * @returns Spelling suggestions with corrected query
   */
  spellCheckDb(term: string, db: string): Promise<SpellCheckResult>
  /**
   ...
   * ```
   */
  epost(pmids: Array<string>): Promise<EPostResult>
  /**
   ...
   * ```
   */
  fetchAllByPmids(pmids: Array<string>): Promise<Array<Article>>
  /**
   ...
   */
  getRelatedArticles(pmids: Array<number>): Promise<RelatedArticles>
  /**
   ...
   * @returns PMC links
   */
  getPmcLinks(pmids: Array<number>): Promise<PmcLinks>
  /**
   ...
   */
  getCitations(pmids: Array<number>): Promise<Citations>
  /**
   ...
   */
  matchCitations(citations: Array<CitationQuery>): Promise<Array<CitationMatch>>
  /**
   ...
   */
  globalQuery(term: string): Promise<GlobalQueryResults>
  /**
   ...
   */
  exportBibtex(pmids: Array<string>): Promise<string>
  /**
   ...
   * @returns RIS string
   */
  exportRis(pmids: Array<string>): Promise<string>
  /**
   ...
   */
  exportCslJson(pmids: Array<string>): Promise<string>
  /**
  ...
  europePmcSearch(
    ...
    resultType?: string | undefined | null,
    sort?: string | undefined | null
  ): Promise<Array<EuropePmcSearchResult>>
  /**
  ...
  europePmcSearchPage(
    ...
    cursorMark?: string | undefined | null,
    sort?: string | undefined | null
  ): Promise<EuropePmcSearchPage>
  /**
   ...
   */
  europePmcGetReferences(
    id: string,
    source?: string | undefined | null
  ): Promise<Array<EuropePmcReferenceEntry>>
  /**
   ...
   */
  europePmcGetCitations(
    id: string,
    source?: string | undefined | null
  ): Promise<Array<EuropePmcCitationEntry>>
  /**
   ...
   */
  europePmcGetDatabaseLinks(
    id: string,
    source?: string | undefined | null
  ): Promise<Array<EuropePmcDatabaseLinkEntry>>
  /**
   ...
   */
  europePmcDownloadSupplementaryFiles(
    id: string,
    outputPath: string,
    source?: string | undefined | null
  ): Promise<string>
...
export interface Citations {
  ...
  sourcePmids: Array<number>
  /** PMIDs of articles citing the source PMIDs */
  citingPmids: Array<number>
}
...
export interface GlobalQueryResults {
  /** The query term that was searched */
  term: string
  /** Per-database record counts */
  results: Array<DatabaseCount>
}
